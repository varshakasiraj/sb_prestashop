...
class itjl_history extends Module{
    protected static $cache_products;
    public function __construct()
    {
        $this->name = 'itjl_history';
        $this->author = 'PrestaShop';
        $this->bootstrap = true;
        parent::__construct();
        $this->displayName = $this->trans('itjl_history');
        $this->description = $this->trans('View Recently Viewed Products');
    }
    ...
    public function hookDisplayHeader(){
        $this->context->controller->registerJavascript('history', '/modules/itjl_history/js/setLocalStorage.js', ['position' => 'bottom', 'priority' => 1000]);
        $this->context->controller->registerJavascript('set_local_storage', '/modules/itjl_history/js/itjl_history.js', ['position' => 'bottom', 'priority' => 1000]);
       
    }
    public function hookDisplayNav2(){
        return  $this->display(__FILE__, 'recentlyViewedCount.tpl');
    }
    public function getProduct($product_ids,$full,$id_lang,$id_shop){
        if(!empty($product_ids)){
            ...
            return itjl_history::$cache_products = $result;   
        }
        return itjl_history::$cache_products;
    }
